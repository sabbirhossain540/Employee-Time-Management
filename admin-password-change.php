        ...
        <div class="well well-custom">
          ...
          <div class="row">
            <div class="col-md-10 col-md-offset-1">
              <div class="well">
                <h3 class="text-center bg-primary">Admin Password Change</h3><br>
                        ...
                        ?>
                          ...
                          <form class="form-horizontal" role="form" action="" method="post" autocomplete="off">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                <input type="password" placeholder="Enter Confirm New Password" name="admin_cnew_password" id="admin_cnew_password" list="expense" min="8" class="form-control input-custom" required>
                              </div>
                            </div>
